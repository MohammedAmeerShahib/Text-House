                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-danger">
                        <div class="box-body">
                            ...
                            <div class="col-sm-10">
                                <input type="Text" class="form-control" id="receiverNo" placeholder="Enter a Contact Number">
                        ...
                        <div class="form-group">
                                <textarea class="form-control" rows="4" placeholder="Enter Messege"></textarea>
                            </div>
